...
class Chat with ChangeNotifier {
  ...
  Future<dynamic> getUserDetailsAndContacts() async {
    ...
    _userDetails = UserModel.fromJson(userData.data() as Map<String,dynamic>);
    _imageUrl = _user.photoURL;

    if (userData.data != null)
      userData['contacts'].forEach((elem) {
        _contacts.add(elem);
      });
    notifyListeners();
    return true;
  ...
  Future<ChatData> getChatData(String peerId) async {
    ...
    final UserModel person = UserModel.fromJson(peer.data() as Map<String,dynamic>);
