...
class _ProfileInfoState extends State<ProfileInfo>
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero).then((value) {
      ...
      db.getUserDocRef(user.uid).then((value) {
        setState(() {
          details = UserModel.fromJson(value.data() as Map<String, dynamic>);
  ...
  void navToEditImage(BuildContext context, User user, String imageUrl) {
  ...
  Widget _buildImageAndName(BuildContext context, User user) {
